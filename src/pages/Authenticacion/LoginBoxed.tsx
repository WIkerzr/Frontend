                            ...
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Email" type="email" placeholder={t('IntroduceEmail')} className="form-input ps-10 placeholder:text-white-dark" />
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Password" type="password" placeholder={t('IntroduceContrasena')} className="form-input ps-10 placeholder:text-white-dark" />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                ...
                                <div>
                                    <label className="flex cursor-pointer items-center">
                                        ...
                                        <span className="text-white-dark">{t('RecordarContrasena')}</span>
                                    </label>
                                </div>
