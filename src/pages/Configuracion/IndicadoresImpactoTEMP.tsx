...
export const categorias: Categorias[] = [
    { id: 1, nameEs: 'Mujeres 1-15 años', nameEu: '', unidadMedida: 1 },
    { id: 2, nameEs: 'Mujeres 16-30 años', nameEu: '', unidadMedida: 1 },
    { id: 3, nameEs: 'Mujeres 31-45 años', nameEu: '', unidadMedida: 1 },
    { id: 4, nameEs: 'Mujeres 46-60 años', nameEu: '', unidadMedida: 1 },
    { id: 5, nameEs: 'Mujeres 61-75 años', nameEu: '', unidadMedida: 1 },
    { id: 6, nameEs: 'Mujeres 76-90 años', nameEu: '', unidadMedida: 1 },
    { id: 7, nameEs: 'Mujeres 91-105 años', nameEu: '', unidadMedida: 1 },
    { id: 8, nameEs: 'Hombres 1-15 años', nameEu: '', unidadMedida: 1 },
    { id: 9, nameEs: 'Hombres 16-30 años', nameEu: '', unidadMedida: 1 },
    { id: 10, nameEs: 'Hombres 31-45 años', nameEu: '', unidadMedida: 1 },
    { id: 11, nameEs: 'Hombres 46-60 años', nameEu: '', unidadMedida: 1 },
    { id: 12, nameEs: 'Hombres 61-75 años', nameEu: '', unidadMedida: 1 },
    { id: 13, nameEs: 'Hombres 76-90 años', nameEu: '', unidadMedida: 1 },
    { id: 14, nameEs: 'Hombres 91-105 años', nameEu: '', unidadMedida: 1 },
    { id: 15, nameEs: 'Total 1-15 años', nameEu: '', unidadMedida: 1 },
    { id: 16, nameEs: 'Total 16-39 años', nameEu: '', unidadMedida: 1 },
    { id: 17, nameEs: 'Total 31-45 años', nameEu: '', unidadMedida: 1 },
    { id: 18, nameEs: 'Total 46-60 años', nameEu: '', unidadMedida: 1 },
    { id: 19, nameEs: 'Total 61-75 años', nameEu: '', unidadMedida: 1 },
    { id: 20, nameEs: 'Total  76-90 años', nameEu: '', unidadMedida: 1 },
    { id: 21, nameEs: 'Total 91-105 años', nameEu: '', unidadMedida: 1 },
    { id: 22, nameEs: '%', nameEu: '', unidadMedida: 2 },
    { id: 23, nameEs: 'Fotovoltaica', nameEu: '', unidadMedida: 7 },
    { id: 24, nameEs: 'Hidráulica', nameEu: '', unidadMedida: 7 },
    { id: 25, nameEs: 'Eólica', nameEu: '', unidadMedida: 7 },
    { id: 26, nameEs: 'Solar térmica', nameEu: '', unidadMedida: 7 },
    { id: 27, nameEs: 'Total Primario', nameEu: '', unidadMedida: 4 },
    { id: 28, nameEs: '% Primario', nameEu: '', unidadMedida: 2 },
    { id: 29, nameEs: 'Total Industria', nameEu: '', unidadMedida: 4 },
    { id: 30, nameEs: '% Industria', nameEu: '', unidadMedida: 2 },
    { id: 31, nameEs: 'Total Construcción', nameEu: '', unidadMedida: 4 },
    { id: 32, nameEs: '% Construcción', nameEu: '', unidadMedida: 2 },
    { id: 33, nameEs: 'Total Servicios', nameEu: '', unidadMedida: 4 },
    { id: 34, nameEs: '% Servicios', nameEu: '', unidadMedida: 2 },
    { id: 35, nameEs: 'Primario', nameEu: '', unidadMedida: 1 },
    { id: 36, nameEs: 'Industria', nameEu: '', unidadMedida: 1 },
    { id: 37, nameEs: 'Construcción', nameEu: '', unidadMedida: 1 },
    { id: 38, nameEs: 'Servicios', nameEu: '', unidadMedida: 1 },
    { id: 39, nameEs: 'Total agrícola', nameEu: '', unidadMedida: 4 },
    { id: 40, nameEs: '% agrícola', nameEu: '', unidadMedida: 2 },
    { id: 41, nameEs: 'Total ganadero', nameEu: '', unidadMedida: 4 },
    { id: 42, nameEs: '% ganadero', nameEu: '', unidadMedida: 2 },
    { id: 43, nameEs: 'Total forestal', nameEu: '', unidadMedida: 4 },
    { id: 44, nameEs: '% forestal', nameEu: '', unidadMedida: 2 },
    { id: 45, nameEs: '% Nivel 0-2 Mujeres', nameEu: '', unidadMedida: 2 },
    { id: 46, nameEs: '%  Nivel 0-2 Hombres', nameEu: '', unidadMedida: 2 },
    { id: 47, nameEs: '%  Nivel 3-4 Mujeres', nameEu: '', unidadMedida: 2 },
    { id: 48, nameEs: '% Nivel 3-4 Hombres', nameEu: '', unidadMedida: 2 },
    { id: 49, nameEs: '% Nivel 5-8 Mujeres', nameEu: '', unidadMedida: 2 },
    { id: 50, nameEs: '% Nivel 5-8 Hombres', nameEu: '', unidadMedida: 2 },
    { id: 51, nameEs: 'Mujeres', nameEu: '', unidadMedida: 1 },
    { id: 52, nameEs: 'Mujeres%', nameEu: '', unidadMedida: 2 },
    { id: 53, nameEs: 'Mujeres€', nameEu: '', unidadMedida: 4 },
    { id: 54, nameEs: 'Hombres', nameEu: '', unidadMedida: 1 },
    { id: 55, nameEs: 'Hombres%', nameEu: '', unidadMedida: 2 },
    { id: 56, nameEs: 'Hombres€', nameEu: '', unidadMedida: 4 },
    { id: 57, nameEs: 'Total', nameEu: '', unidadMedida: 1 },
    { id: 58, nameEs: 'Total%', nameEu: '', unidadMedida: 2 },
    { id: 59, nameEs: 'TotalH', nameEu: '', unidadMedida: 3 },
    { id: 60, nameEs: 'Total€', nameEu: '', unidadMedida: 4 },
];
